  ...
  "places": [
    {
      "title": "Bílý Kříž",
      "baseLayer": "osm",
      "extent": [18.550, 49.462, 18.557, 49.528],
      "campaigns": [
        {
      ...
      "campaigns": [
        {
          ...
          "datasets": [
            {
              "title": "SASI 10:15 2.0 m",
              "date": "2015-07-07 11:00Z",
              "dataTypes": ['hyper','them'],
            ...
            {
              "title": "TASI 10:15 2 m",
              "date": "2015-07-07 11:00Z",
              "dataTypes": ['termo','them'],
              "ekosystemTypes": ['město'],
              "layer": {
                "type": 'gwc',
              ...
              "legendUrl": {
                'cs': '_cfg/legend/Brno_TASI.png',
                'en': '_cfg/legend/Brno_TASI_en.png'
              }
            }]
        }]
    },
...

    {
      ...
      "campaigns": [
        ...
        {
          "dateRange": ["2010-07-11", "2010-07-12"],
          "datasets": [
            {
              "title": "HS 09:50 1.0m",
